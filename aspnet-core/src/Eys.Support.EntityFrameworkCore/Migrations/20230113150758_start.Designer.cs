...
namespace Eys.Support.Migrations
{
    ...
    [Migration("20230113150758_start")]
    partial class start
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eys.Support.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Eys.Support.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Eys.Support.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Eys.Support.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Eys.Support.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Eys.Support.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Eys.Support.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Eys.Support.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Eys.Support.Authorization.Users.User", "LastModifierUser")
                        .WithMany()

...
{
    public abstract class SupportWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SupportWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SupportWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SupportDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SupportDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SupportDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SupportDbContext, Task<T>> func)
        {
            T result;
